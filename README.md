...
| ログイン | ダッシュボード |
|---------|-------------|
| ![ログイン](docs/screenshots/01_login.png) | ![ダッシュボード](docs/screenshots/02_dashboard.png) |

| プロジェクト詳細 | コンテンツ詳細・AI提案 |
|----------------|----------------------|
| ![プロジェクト詳細](docs/screenshots/03_project.png) | ![コンテンツ詳細](docs/screenshots/04_content.png) |

| 設定画面 |
|---------|
| ![設定](docs/screenshots/05_settings.png) |
